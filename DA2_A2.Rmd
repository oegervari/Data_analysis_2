...
In this analysis I investigate whether there is a relationship between a hotels' (high) rating and their stars and distance to the city center. I used the [hotel-europe dataset](https://osf.io/p6tyr/) with the location set to Berlin. 
